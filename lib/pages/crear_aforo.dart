  ...
  Future<void> _guardarAforo() async {
    ...
    try {
      ...
      await _supabase.from('dbAforos').insert({
        ...
        'C33': double.parse(_c33Controller.text),
        'C34': double.parse(_c34Controller.text),
        'C35': double.parse(_c35Controller.text),
        'C37': double.parse(_c37Controller.text),
        'C40': double.parse(_c40Controller.text),
      });
